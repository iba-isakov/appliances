        ...
        <div class="catalog__block_menu">
            ...
            <ul class="catalog__block_list">
                <li v-for="mainCategory in mainCategories"
                    ...
                    <img class="chevron__catalog" v-bind:class="mainCategory.id === activeCategoryTabId ? 'chevron__catalog_style' : ''" src="/css/img/chevron_right.svg" alt="">
                </li>
        ...
        <div class="catalog__block_content">
            ...
            <div class="home__container_element_mobile catalog__content">
                <div class="home__container_element_mobile_box catalog__content_box">
                    <div v-for="subcategory in currentCategory.sub_categories" class="home__container_element_mobile_box_item catalog__content_item">
